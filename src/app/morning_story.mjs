export default [{
	...
	enter: {
		...
		fail: "Good teeth can impact so many areas of life, including how you feel about yourself. The health of the brain impacts body health and social mobility, and that impacts family health. Everything is connected, we are all connected. We are supposed to love and care for our neighbours, right?"
	}
},{
	id: "toothbrush",
	type: "thing",
	...
	use: [{
		dont_have: "toothbrush",
		fail: "Doesn't really work, are you going to move your teeth to the toothbrush?"
	},{
		succeed: "Swrrr... swwwrr.... Brushing sound... Your teeth are now clean..."
	}],
},{
	id: "slippers",
	type: "thing",
	...
	use: [{
		dont_have: "slippers",
		fail: "In order to wear your slippers, you first need to pick them up."
	},{
		succeed: "You put the slippers on your feet"
	}]
},{
	id: "lamp",
	type: "thing",
	...
	location: "bedroom",
	use: {
		succeed: "Igniting the world anew with such brilliance! You can suddenly see where you are going."
	},
	pickup: {
	...
	use: [{
		have: "slippers",
		fail: "Your slippers would get all wet and soggy if you shower with them on."
	},{
		succeed: "Aaahhh... Nice!!!"
	}],
	pickup: {
